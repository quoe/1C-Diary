...
Процедура ПередНачаломРаботыСистемы(Параметры) Экспорт
	...
	ДневникВызовСервера.ПроверитьНачальныеНастройкиИнтерфейса(Параметры.Отказ, , ОбновлятьИнтерфейс);
	Если Параметры.Отказ Тогда
		// Перезапускаем предприятие
		Параметры.Перезапустить = Истина;
		ЗавершитьРаботуСистемы(Ложь, Истина);
	ИначеЕсли ОбновлятьИнтерфейс Тогда 
		ОбновитьИнтерфейс();
	КонецЕсли; 
	// Конец ДЕНЬГИ
...
Процедура ПриНачалеРаботыСистемы(Параметры) Экспорт
	...
	// ДЕНЬГИ
	//ДневникВызовСервера.ПроверитьПределПланирования(); //+++
	// Конец ДЕНЬГИ
...
Процедура ПослеНачалаРаботыСистемы() Экспорт
	...
	//
	//// Нужно ди начинать с помощника начала работы?
	//Если ПараметрыРаботыКлиента.ОткрытьПомощникНачалаРаботы Тогда
	//	
	//	ДневникВызовСервера.УстановитьИнтерфейсПриложенияПоФорме("Обработка.ПомощникНачалаРаботы.Форма", Истина);
	//	ОбновитьИнтерфейс();
	//	Возврат;
	//	
	//КонецЕсли;
	//
	//// Какой раздел открывать при запуске?
	//Если ПараметрыРаботыКлиента.Свойство("ПриЗапускеОткрыватьРаздел") Тогда
	//	
	//	Если Нрег(ПараметрыРаботыКлиента.ПриЗапускеОткрыватьРаздел) = "операции"  Тогда
	//		ОткрытьФорму("Обработка.РазделОперации.Форма.СписокДокументовИОстатки");
	//	ИначеЕсли Нрег(ПараметрыРаботыКлиента.ПриЗапускеОткрыватьРаздел) = "бюджет"  Тогда
	//		ОткрытьФорму("Обработка.РазделБюджет.Форма.ФормаРаздела");
	//	ИначеЕсли Нрег(ПараметрыРаботыКлиента.ПриЗапускеОткрыватьРаздел) = "календарь"  Тогда
	//		ОткрытьФорму("Обработка.ПлановыеОперации.Форма.ФормаКалендаря");
	//	ИначеЕсли Нрег(ПараметрыРаботыКлиента.ПриЗапускеОткрыватьРаздел) = "накопления"  Тогда
	//		ОткрытьФорму("Обработка.РазделНакопления.Форма.ОсновнаяФорма");
	//	КонецЕсли; 
	//	
	//КонецЕсли; 
