...
Функция Get(URL, ПараметрыЗапроса = Неопределено, ДополнительныеПараметры = Неопределено) Экспорт
	...
	Возврат ВызватьМетодВСеансе(Сессия, "GET", URL, ДополнительныеПараметры);
...
Функция Options(URL, ДополнительныеПараметры = Неопределено) Экспорт
	...
	Возврат ВызватьМетодВСеансе(Сессия, "OPTIONS", URL, ДополнительныеПараметры);
...
Функция Head(URL, ДополнительныеПараметры = Неопределено) Экспорт
	...
	Сессия = СоздатьСессию();
	ЗаполнитьДополнительныеДанные(ДополнительныеПараметры, Неопределено, Неопределено, Неопределено);
	Возврат ВызватьМетодВСеансе(Сессия, "HEAD", URL, ДополнительныеПараметры);
...
Функция Post(URL, Данные = Неопределено, ДополнительныеПараметры = Неопределено) Экспорт
	...
	Возврат ВызватьМетодВСеансе(Сессия, "POST", URL, ДополнительныеПараметры);
...
Функция Put(URL, Данные = Неопределено, ДополнительныеПараметры = Неопределено) Экспорт
	...
	Сессия = СоздатьСессию();
	ЗаполнитьДополнительныеДанные(ДополнительныеПараметры, Неопределено, Данные, Неопределено);
	Возврат ВызватьМетодВСеансе(Сессия, "PUT", URL, ДополнительныеПараметры);
...
Функция Patch(URL, Данные = Неопределено, ДополнительныеПараметры = Неопределено) Экспорт
	...
	Сессия = СоздатьСессию();
	ЗаполнитьДополнительныеДанные(ДополнительныеПараметры, Неопределено, Данные, Неопределено);
	Возврат ВызватьМетодВСеансе(Сессия, "PATCH", URL, ДополнительныеПараметры);
...
Функция Delete(URL, Данные = Неопределено, ДополнительныеПараметры = Неопределено) Экспорт
	...
	Сессия = СоздатьСессию();
	ЗаполнитьДополнительныеДанные(ДополнительныеПараметры, Неопределено, Данные, Неопределено);
	Возврат ВызватьМетодВСеансе(Сессия, "DELETE", URL, ДополнительныеПараметры);
...
Функция GetJson(URL, ПараметрыЗапроса = Неопределено, ДополнительныеПараметры = Неопределено) Экспорт
	...
	Возврат КакJson(ВызватьМетодВСеансе(Сессия, "GET", URL, ДополнительныеПараметры), ПараметрыПреобразованияJSON);
...
Функция PostJson(URL, Json, ДополнительныеПараметры = Неопределено) Экспорт
	...
	ПараметрыПреобразованияJSON = 
		ВыбратьЗначение(Неопределено, ДополнительныеПараметры, "ПараметрыПреобразованияJSON", Неопределено);
	Возврат КакJson(ВызватьМетодВСеансе(Сессия, "POST", URL, ДополнительныеПараметры), ПараметрыПреобразованияJSON);
...
Функция PutJson(URL, Json, ДополнительныеПараметры = Неопределено) Экспорт
	...
	ПараметрыПреобразованияJSON = 
		ВыбратьЗначение(Неопределено, ДополнительныеПараметры, "ПараметрыПреобразованияJSON", Неопределено);
	Возврат КакJson(ВызватьМетодВСеансе(Сессия, "PUT", URL, ДополнительныеПараметры), ПараметрыПреобразованияJSON);
...
Функция DeleteJson(URL, Json, ДополнительныеПараметры = Неопределено) Экспорт
	...
	ПараметрыПреобразованияJSON = 
		ВыбратьЗначение(Неопределено, ДополнительныеПараметры, "ПараметрыПреобразованияJSON", Неопределено);
	Возврат КакJson(ВызватьМетодВСеансе(Сессия, "DELETE", URL, ДополнительныеПараметры), ПараметрыПреобразованияJSON);
...
Функция ВызватьМетод(Метод, URL, ДополнительныеПараметры = Неопределено) Экспорт 
	...
	Сессия = СоздатьСессию();
	ЗаполнитьДополнительныеДанные(ДополнительныеПараметры, Неопределено, Неопределено, Неопределено);
	Возврат ВызватьМетодВСеансе(Сессия, Метод, URL, ДополнительныеПараметры);
...
Функция ВызватьМетодВСеансе(Сессия, Метод, URL, ДополнительныеПараметры = Неопределено) Экспорт
	...
	ЗаполнитьДополнительныеДанные(ДополнительныеПараметры, Неопределено, Неопределено, Неопределено);
	Возврат ВызватьHTTPМетод(Сессия, Метод, URL, ДополнительныеПараметры);
