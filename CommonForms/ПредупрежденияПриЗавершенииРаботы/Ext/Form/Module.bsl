...
Процедура СоздатьФлажокНаФорме(СтруктураВопроса)
	...
	// ДЕНЬГИ
	НовоеПолеФормы.ПоложениеЗаголовка   = ПоложениеЗаголовкаЭлементаФормы.Нет;
	НовоеПолеФормы.Подсказка            = НовоеПолеФормы.Заголовок;
	НовоеПолеФормы.ОтображениеПодсказки = ОтображениеПодсказки.ОтображатьСправа;
	// Конец ДЕНЬГИ
